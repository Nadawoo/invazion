...
class HtmlPage
{
    ...
    function page_header($css_path=NULL)
    {
        ...
        return '<!doctype html>
            ...
            <head>
                ...
                <link rel="stylesheet" type="text/css" href="resources/css/gamelayout.css?v5.6">
                ...
                <link rel="stylesheet" type="text/css" href="resources/css/wall.css?v2.3">
    ...
    function page_footer()
    {
        ...
        return '        </div>
                    ...
                    <script type="text/javascript" src="resources/js/events.js?v3.8"></script>
                </body>
            </html>';
    }
