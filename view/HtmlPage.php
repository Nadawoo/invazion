...
class HtmlPage
{
    ...
    function page_header($css_path=NULL)
    {
        ...
        return '<!doctype html>
            ...
            <head>
                ...
                <link rel="stylesheet" type="text/css" href="resources/css/sitelayout.css?v3.5">
                <link rel="stylesheet" type="text/css" href="resources/css/gamelayout.css?v4.7">
    ...
    function page_footer()
    {
        ...
        return '        </div>
                    <script type="text/javascript" src="resources/scripts.js?v3.2"></script>
                </body>
            </html>';
    }
