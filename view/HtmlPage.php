...
class HtmlPage
{
    ...
    function page_header($css_path=NULL)
    {
        ...
        return '<!doctype html>
            ...
            <head>
                ...
                <link rel="stylesheet" type="text/css" href="resources/css/sitelayout.css?v3.6">
                <link rel="stylesheet" type="text/css" href="resources/css/gamelayout.css?v5.1">
                <link rel="stylesheet" type="text/css" href="resources/css/map.css?v2.5">
                <link rel="stylesheet" type="text/css" href="resources/css/smartphone.css?v1.4">
                <link rel="stylesheet" type="text/css" href="resources/css/myzone.css?v1.3">
                <link rel="stylesheet" type="text/css" href="resources/css/city.css?v2.3">
    ...
    function page_footer()
    {
        ...
        return '        </div>
                    ...
                    <script type="text/javascript" src="resources/js/discussTemplate.js?v3.4"></script>
                    <script type="text/javascript" src="resources/js/scripts.js?v3.5"></script>
                    <script type="text/javascript" src="resources/js/events.js?v3.4"></script>
                </body>
            </html>';
    }
