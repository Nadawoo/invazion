...
class HtmlPage
{
    ...
    function page_header($css_path=NULL)
    {
        ...
        return '<!doctype html>
            ...
            <head>
                ...
                <link rel="stylesheet" type="text/css" href="resources/css/gamelayout.css?v7.1">
                ...
                <link rel="stylesheet" type="text/css" href="resources/css/city.css?v3.0">
    ...
    function page_footer()
    {
        ...
        return '
                    ...
                    <script type="text/javascript" src="resources/js/scripts.js?v6.0"></script>
