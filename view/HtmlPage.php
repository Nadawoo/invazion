...
class HtmlPage
{
    ...
    function page_header($css_path=NULL)
    {
        ...
        return '<!doctype html>
            ...
            <head>
                ...
                <link rel="stylesheet" type="text/css" href="resources/css/gamelayout.css?v3.7">
                <link rel="stylesheet" type="text/css" href="resources/css/map.css?v2.0">
                ...
                <link rel="stylesheet" type="text/css" href="resources/css/popup.css?v1.4">
                ' . $css_link . '
    ...
    function page_footer()
    {
        ...
        return '        </div>
                    <script type="text/javascript" src="resources/scripts.js?v2.1"></script>
                </body>
            </html>';
    }
