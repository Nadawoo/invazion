...
class HtmlPage
{
    ...
    function page_header($css_path=NULL)
    {
        ...
        return '<!doctype html>
            ...
            <head>
                ...
                <link rel="stylesheet" type="text/css" href="resources/css/gamelayout.css?v5.5">
                ...
                <link rel="stylesheet" type="text/css" href="resources/css/city.css?v2.6">
    ...
    function page_footer()
    {
        ...
        return '        </div>
                    ...
                    <script type="text/javascript" src="resources/js/scripts.js?v3.7"></script>
