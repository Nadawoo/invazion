...
class HtmlPage
{
    ...
    function page_header($css_path=NULL)
    {
        ...
        return '<!doctype html>
            ...
            <head>
                ...
                <link rel="stylesheet" type="text/css" href="resources/css/sitelayout.css?v3.7">
    ...
    function page_footer()
    {
        ...
        return '        </div>
                    ...
                    <script type="text/javascript" src="resources/js/wallTemplate.js?v3.5"></script>
                    <script type="text/javascript" src="resources/js/scripts.js?v4.4"></script>
                    <script type="text/javascript" src="resources/js/events.js?v4.1"></script>
                </body>
            </html>';
    }
