 ...
 * @return {string} HTML
 */
function htmlAttackDoorOpen(apiData) {
    ...
    return {
        ...
        "message" : '<strong class="red">Les portes de la ville n\'étaient pas fermées !</strong>\
            Cette négligence a permis aux <strong>'+(apiData.zombies-apiData.defenses)+'</strong> zombies \n\
            de pénétrer en contournant les <strong>'+apiData.defenses+'</strong> défenses.\
            <br>Bilan :\
                <ul>\
                    <li>&#x26B0;&#xFE0F; <strong>'+apiData.citizens_killed+' morts</strong> (nom1, nom2)</li>\
                    <li>&#x1F9CD;&nbsp; <strong>'+apiData.citizens_survivors+' survivants</strong> (nom3, nom4, nom5)</li>\
