...
class HtmlPage
{
    ...
    function page_header($css_path=NULL)
    {
        ...
        return '<!doctype html>
            ...
            <head>
                ...
                <link rel="stylesheet" type="text/css" href="resources/css/gamelayout.css?v7.6">
                <link rel="stylesheet" type="text/css" href="resources/css/map.css?v3.6">
    ...
    function page_footer()
    {
        ...
        return '
                    ...
                    <script type="text/javascript" src="resources/js/scripts.js?v7.4"></script>
