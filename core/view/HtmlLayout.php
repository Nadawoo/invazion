...
class HtmlLayout extends HtmlPage
{
     ...
     * @param string $json_buildings_components The items required to build a building
            ...
            <div id="action_zombies">
                ...
                <div class="buttons_kill">
                    <button class="redbutton"
                        ...
                        title="Attaquer un zombie à mains nues. Vous gagnerez un trophée en cas de succès.">
                        <div class="icon">&#x1F91C;&#x1F3FC;</div> Mains nues [-'.$ap_cost.'&#x26A1;]
                    </button>
                    <button class="redbutton"
                        data-action="killMassZombies"
                        title="Comme les zombies sont particulièrement nombreux ici, vous pouvez les attaquer par groupe.'
                             ."\nC'est très efficace, mais en contrepartie vous ne gagnerez aucun trophée.\""
                        .'>
                        <div class="icon">&#x1F525;</div> Lance-flammes
                    </button>
                    <button class="redbutton"
...
//        }
    ...
    function block_zombie_powers() {
        ...
        return '
            ...
            <img src="resources\img\copyrighted\chemistry_64px.png" alt="&#9763;&#65039;" height="32" width="32"> Empoisonner l\'eau <abbr title="Les rations d\'eau consommées par les humains ne leur restaurent que la moitié des points d\'action normaux. L\'effet dure pendant 1 cycle.">[?]</abbr><br>
            ...
            <img src="resources\img\copyrighted\wound_64px.png" alt="&#129656;" height="32" width="32"> Blesser un humain <abbr title="50% de risque qu\'un humain, choisi aléatoirement, reçoive une blessure à la fin du cycle.">[?]</abbr><br>
            <img src="resources\img\copyrighted\oracle_64px.png" alt="&#128374;&#65039;" height="32" width="32"> Obscurcir la carte <abbr title="Masque temporairement toutes les zones de la carte, comme si elle n\'avait jamais été explorée. L\'effet dure pendant 1 cycle.">[?]</abbr><br>
            <img src="resources\img\copyrighted\forging_64px.png" alt="&#128295;" height="32" width="32"> Empêcher les assemblages <abbr title="Les humains ne peuvent plus fabriquer d\'objets à partir de composants. L\'effet dure pendant 1 cycle.">[?]</abbr><br>
            <img src="resources\img\copyrighted\city_door_64px.png" alt="" height="32" width="32"> Saboter la porte <abbr title="Manipuler la porte de la ville coûte 2 points d\'action au lieu d\'un seul.">[?]</abbr>
            ';
    }
    ...
    function block_map_navigation() {
        ...
        return '
            ...
            <button aria-label="Afficher le smartphone du jeu"
                style="display:none"
                >
                <a href="#popsmartphone" style="font-size:55%" data-action="displayPhone">&#128241;</a>
            </button>
