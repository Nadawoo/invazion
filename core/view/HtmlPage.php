...
class HtmlPage
{
    ...
    function page_header($css_path=NULL)
    {
        ...
        return '<!doctype html>
            ...
            <head>
                ...
                <link rel="stylesheet" type="text/css" href="resources/css/gamelayout.css?v8.9">
    ...
    function page_footer()
    {
        ...
        return '
                    ...
                    <script type="text/javascript" src="resources/js/actionBlocks.func.js?v1.4"></script>
                    ...
                    <script type="text/javascript" src="resources/js/misc.func.js?v9.6"></script>
