...
//                }
            ...
            zone.insertAdjacentHTML("afterbegin", `<button aria-label="Bâtiment : ${buildingName}" class="icon_html" style="font-size:${buildingEmojiSize}em;"><span role="img">${buildingIconHtml}</span></button>`);
            // Delete the "&nbsp;" required on the empty zones 
//            if(zone.querySelector(".empty") !== null) {
//                zone.querySelector(".empty").remove();
//            }
