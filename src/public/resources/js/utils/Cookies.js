...
class Cookies {
     ...
     */
    setCookieConfig(paramName, paramValue) {

        let cookieContent = this.getCookieConfig();
        cookieContent[paramName] = paramValue;
        this.setCookie("config", JSON.stringify(cookieContent));
    }
     ...
     */
    getCookieConfig(paramName=null) {
        let cookieContent = this.getCookie("config");
